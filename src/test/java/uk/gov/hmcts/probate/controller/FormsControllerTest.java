...
//        when(submitService.update(eq(EMAIL_ADDRESS), eq(ProbateType.INTESTACY), eq(RETURN_URL))).thenReturn(intestacyForm);
//        when(submitService.update(eq(EMAIL_ADDRESS), eq(ProbateType.CAVEAT), eq(RETURN_URL))).thenReturn(caveatForm);
//
...
//                .andExpect(status().isOk())
//                .andExpect(content().json(intestacyFormJsonStr, true));
//        verify(submitService, times(1)).update(eq(EMAIL_ADDRESS), eq(ProbateType.INTESTACY), eq(RETURN_URL));
//
//        mockMvc.perform(put(FORMS_ENDPOINT + "/" + EMAIL_ADDRESS+ "/" + SUBMISSIONS_ENDPOINT)
...
//                .andExpect(status().isOk())
//                .andExpect(content().json(caveatFormJsonStr, true));
//        verify(submitService, times(1)).update(eq(EMAIL_ADDRESS), eq(ProbateType.CAVEAT), eq(RETURN_URL));
//
//    }
//
//    @Test
