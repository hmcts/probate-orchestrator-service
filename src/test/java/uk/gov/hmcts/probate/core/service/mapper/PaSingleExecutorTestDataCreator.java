...
public class PaSingleExecutorTestDataCreator {
    ...
    public static GrantOfRepresentationData createGrantOfRepresentation() {
        return GrantOfRepresentationData.builder()
                ...
                .legalStatement(uk.gov.hmcts.reform.probate.model.cases.grantofrepresentation.LegalStatement.builder()
                        ...
                        .deceasedOtherNames(DECEASED_OTHER_NAMES)
                        .executorsApplying(Lists.newArrayList(
                                CollectionMember.<uk.gov.hmcts.reform.probate.model.cases.grantofrepresentation.LegalStatementExecutorApplying>builder()
                                        .value(uk.gov.hmcts.reform.probate.model.cases.grantofrepresentation.LegalStatementExecutorApplying.builder()
                                                .sign(SIGN)
                                                .name(NAME)
                                                .build())
                                        .build()
