...
public class IhtValuesMapper {
    ...
    public BigDecimal getNetNotRequired(IhtFormType ihtFormType, Long ihtNetValue) {
    ...
    public BigDecimal getGrossNotRequired(IhtFormType ihtFormType, Long ihtNetValue) {
        if (IhtFormType.optionNotRequired.equals(ihtFormType)) {
            return  new PoundsConverter().penniesToPounds(ihtNetValue);
        }
        return null;
