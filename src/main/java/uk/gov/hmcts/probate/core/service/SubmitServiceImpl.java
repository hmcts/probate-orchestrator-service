...
public class SubmitServiceImpl implements SubmitService {
    ...
    public SubmitServiceImpl(
            ...
            final SubmitServiceApi submitServiceApi,
            final BackOfficeService backOfficeService,
    ...
    public Form getCase(String identifier, ProbateType probateType) {
        ...
        ProbateCaseDetails probateCaseDetails = submitServiceApi.getCaseById(authorisation,
    ...
    public Form updatePayments(String identifier, Form form) {
        ...
        final String caseType = form.getType().getCaseType().name();
        String authorisation = securityUtils.getAuthorisation();
        String serviceAuthorisation = securityUtils.getServiceAuthorisation();
