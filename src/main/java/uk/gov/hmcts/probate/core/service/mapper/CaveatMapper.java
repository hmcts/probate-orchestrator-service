...
@Mapper(componentModel = "spring", uses = {PaymentsMapper.class, CaveatAliasNameMapper.class,
...
public interface CaveatMapper extends FormMapper<CaveatData, CaveatForm> {
    ...
    @Mapping(target = "deceased.otherNames", source = "deceasedFullAliasNameList", qualifiedBy = {
        FromCaveatCollectionMember.class})
