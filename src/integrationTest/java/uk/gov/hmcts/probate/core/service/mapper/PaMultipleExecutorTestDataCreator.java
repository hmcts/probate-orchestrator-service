...
public final class PaMultipleExecutorTestDataCreator {
    ...
    private static final ExecutorNotApplyingReason FIRST_EXECUTOR_NOT_APPLYING_KEY =
        ExecutorNotApplyingReason.DIED_BEFORE;
    private static final ExecutorNotApplyingReason SECOND_EXECUTOR_NOT_APPLYING_KEY =
        ExecutorNotApplyingReason.DIED_BEFORE;
    ...
    private static String LEGAL_DECLARATION_JSON =
        "{\"legalDeclaration\":{\"headers\":[\"header0\",\"header1\",\"header2\"],"
            ...
            + "\"values\":[\"value0\",\"value1\",\"value2\"]}]}],\"dateCreated\":\""
            + "date and time\",\"deceased\":\"deceased\"}}";
